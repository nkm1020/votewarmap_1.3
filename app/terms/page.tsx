    ...
    <main className="min-h-screen bg-[#070d16] px-4 py-10 text-white sm:px-6 lg:px-10">
      <article className="mx-auto w-full max-w-4xl rounded-3xl border border-white/12 bg-[rgba(12,18,28,0.86)] p-6 shadow-2xl sm:p-8">
        <header className="border-b border-white/12 pb-6">
          ...
          <h1 className="mt-3 text-2xl font-extrabold text-white sm:text-3xl">VoteWarMap 이용약관</h1>
        ...
        <section className="mt-6 space-y-6 text-sm leading-7 text-white/80">
          ...
          <div>
            <h2 className="text-base font-bold text-white">제2조 (정의)</h2>
          ...
          <div>
            <h2 className="text-base font-bold text-white">제3조 (약관의 효력 및 변경)</h2>
            <p className="mt-2">
          ...
          <div>
            <h2 className="text-base font-bold text-white">제4조 (서비스의 제공 및 변경)</h2>
            <ul className="mt-2 list-disc space-y-1 pl-5">
          ...
          <div>
            <h2 className="text-base font-bold text-white">제5조 (이용자의 의무)</h2>
          ...
          <div>
            <h2 className="text-base font-bold text-white">제6조 (운영자의 조치)</h2>
            <p className="mt-2">
          ...
          <div>
            <h2 className="text-base font-bold text-white">제7조 (지식재산권 및 데이터 이용)</h2>
            <ul className="mt-2 list-disc space-y-1 pl-5">
          ...
          <div>
            <h2 className="text-base font-bold text-white">제8조 (면책)</h2>
            <ul className="mt-2 list-disc space-y-1 pl-5">
          ...
          <div>
            <h2 className="text-base font-bold text-white">제9조 (준거법 및 관할)</h2>
            <p className="mt-2">
          ...
          <div>
            <h2 className="text-base font-bold text-white">제10조 (문의)</h2>
            <ul className="mt-2 list-disc space-y-1 pl-5">
